		...
		<div class="row">
			<div class="col-md-6">
			  <div class="form-group">
			    ...
			    <input type="text" class="form-control" id="ma" placeholder="VD: NQT001" value="<?php echo $ma; ?>">
			...
			<div class="col-md-6">
			  <div class="form-group">
			    ...
			    <input type="text" class="form-control" id="hoten" placeholder="VD: Nguyễn Văn An" value="<?php echo $hoten ?>">
