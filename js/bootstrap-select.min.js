        ...
        Selectpicker.prototype = {
            ...
            createDropdown: function() {
                ...
                var donebutton = this.multiple && this.options.doneButton ?
                    ...
                    : '';
                var drop =
                    '<div class="btn-group bootstrap-select' + showTick + inputGroup + '" style="border: 1px solid #ced4da;">' +
                    '<button type="button" class="' + this.options.styleBase + ' dropdown-toggle" data-toggle="dropdown"' + autofocus + ' role="button" style="background:#fff;">' +
