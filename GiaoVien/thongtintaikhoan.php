		...
		<div class="row">
			...
			<div class="col-md-6">
			  <div class="form-group">
			    ...
			    <input type="text" class="form-control" id="sodienthoai" placeholder="VD: 090 xxx xxx" value="<?php echo $sodienthoaigv; ?>">
			...
			<div class="col-md-6">
			  <div class="form-group">
			    ...
			    <input type="text" class="form-control" id="mail" placeholder="VD: xyz@gmail.com" value="<?php echo $mailgv ?>">
